                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <dl>
                                                        ...
                                                        <dd>{{$email->sex}}</dd>
                                                        <dt>Geboortedatum:</dt>
                                                        <dd>{{$email->birthday}}</dd>
                                                        <dt>Nationaliteit:</dt>
                                                        <dd>{{$email->nationality}}</dd>
                                                        <dt>Adres:</dt>
                                                        <dd>{{$email->address}}</dd>
                                                        <dt>Postcode:</dt>
                                                        <dd>{{$email->postalcode}}</dd>
                                                        <dt>Plaats:</dt>
                                                        <dd>{{$email->city}}</dd>
                                                        <dt>Land:</dt>
                                                        <dd>{{$email->country}}</dd>
                                                        <dt>Mobiele telefoonnummer:</dt>
                                                        <dd>{{$email->phonenumber}}</dd>
                                                        <dt>Email:</dt>
                                                        <dd>{{$email->email}}</dd>
                                                        <dt>Commissie:</dt>
                                                        <dd>{{$email->commission}}</dd>
                                                        <dt>Dispuut:</dt>
                                                        <dd>{{$email->dispuut}}</dd>
                                                        <dt>Studentnummer:</dt>
                                                        <dd>{{$email->studentnumber}}</dd>
                                                        <dt>Studie:</dt>
                                                        <dd>{{$email->study}}</dd>
                                                        <dt>Studiejaar aanmelding:</dt>
                                                        <dd>{{$email->startingstudyyear}}</dd>
                                                        <dt>Internationaal:</dt>
                                                        @if($email->international = 0)
                                                            <dd>Nee</dd>
                                                        @else
                                                            <dd>Ja</dd>
                                                        @endif
